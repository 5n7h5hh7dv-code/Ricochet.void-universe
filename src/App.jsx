            ...
            <div className="card grid4">
              {signals.map((signal, index) => {
                ...
                return (
                  <div
                    key={signal.title}
                    className={`universeCard ${verified ? "verified" : ""} ${current ? "current" : ""} ${locked ? "locked" : ""}`}
                  >
                ...
                <div className="universeCard greenCard" key={artifact.code}>
                  ...
                  <div className="counterBar">
                    <div
                      ...
                      style={{ width: `${(artifact.minted / artifact.limit) * 100}%` }}
                    ></div>
                  </div>
